...
#define ENUM_FIELDS \
    X(PREPROC_FAIL_ITEMS_EXCEEDED) \
    X(PREPROC_FAIL_STATES_EXCEEDED) \
    X(PREPROC_FAIL_BRANCHES_EXCEEDED) \
    X(PREPROC_FAIL_DFA_STATES_EXCEEDED) \
    X(PREPROC_FAIL_TNFA_TAGS_EXCEEDED) \
    X(PREPROC_FAIL_TNFA_TRANSITIONS_EXCEEDED) \
    X(PREPROC_FAIL_TDFA_STATES_EXCEEDED) \
    X(PREPROC_FAIL_TDFA_TRANSITIONS_EXCEEDED) \
    X(PREPROC_FAIL_TDFA_REGISTERS_EXCEEDED) \
    X(PREPROC_FAIL_TDFA_REGOPS_EXCEEDED) \
    X(PREPROC_FAIL_TDFA_UNSUPPORTED_ASSERTION) \
    X(PREPROC_FAIL_NO_BRANCHES)
#include "xenums.c"
