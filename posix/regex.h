...
extern regoff_t re_search(struct re_pattern_buffer *__buffer, char *__String,
...
extern regoff_t re_search_2(struct re_pattern_buffer *__buffer, char *__string1,
                            regoff_t __length1, char *__string2,
                            regoff_t __length2, regoff_t __start,
                            regoff_t __range, struct re_registers *__regs,
                            regoff_t __stop)
    _Attr_access_((__read_only__, 2, 3)) _Attr_access_((__read_only__, 4, 5));

/* Like 're_search', but return how many characters in STRING the regexp
   in BUFFER matched, starting at position START.  */
extern regoff_t re_match(struct re_pattern_buffer *__buffer, char *__String,
                         regoff_t __length, regoff_t __start,
                         struct re_registers *__regs)
    _Attr_access_((__read_only__, 2, 3));

/* Relates to 're_match' as 're_search_2' relates to 're_search'.  */
extern regoff_t re_match_2(struct re_pattern_buffer *__buffer, char *__string1,
                           regoff_t __length1, char *__string2,
                           regoff_t __length2, regoff_t __start,
...
extern void re_set_registers(struct re_pattern_buffer *__buffer,
                             struct re_registers *__regs, int64 __num_regs,
...
#else
#if ((199901L <= __STDC_VERSION__ || 3 < __GNUC__ + (1 <= __GNUC_MINOR__)      \
      || __clang_major__ >= 3)                                                 \
     && !defined __cplusplus)
